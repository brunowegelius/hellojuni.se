...
WordPress version: required at least 5.0, tested up to 5.8.3
...
Please install and activate it before starting to use the theme Yucca.
...
Theme documentation is available on http://yucca.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Yucca is Fontello.
