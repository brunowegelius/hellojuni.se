...
if ( ! function_exists( 'yucca_tribe_events_get_css' ) ) {
	add_filter( 'yucca_filter_get_css', 'yucca_tribe_events_get_css', 10, 2 );
	function yucca_tribe_events_get_css( $css, $args ) {
