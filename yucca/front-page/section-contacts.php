<div class="front_page_section front_page_section_contacts<?php
	$yucca_scheme = yucca_get_theme_option( 'front_page_contacts_scheme' );
	if ( ! empty( $yucca_scheme ) && ! yucca_is_inherit( $yucca_scheme ) ) {
		echo ' scheme_' . esc_attr( $yucca_scheme );
	}
	echo ' front_page_section_paddings_' . esc_attr( yucca_get_theme_option( 'front_page_contacts_paddings' ) );
	if ( yucca_get_theme_option( 'front_page_contacts_stack' ) ) {
		echo ' sc_stack_section_on';
	}
?>"
		<?php
		$yucca_css      = '';
		$yucca_bg_image = yucca_get_theme_option( 'front_page_contacts_bg_image' );
...
<?php
	// Add anchor
	$yucca_anchor_icon = yucca_get_theme_option( 'front_page_contacts_anchor_icon' );
	$yucca_anchor_text = yucca_get_theme_option( 'front_page_contacts_anchor_text' );
...
?>
	...
	<?php
	if ( yucca_get_theme_option( 'front_page_contacts_fullheight' ) ) {
	...
	?>
			...
			<?php
			$yucca_css      = '';
			$yucca_bg_mask  = yucca_get_theme_option( 'front_page_contacts_bg_mask' );
			$yucca_bg_color_type = yucca_get_theme_option( 'front_page_contacts_bg_color_type' );
			if ( 'custom' == $yucca_bg_color_type ) {
				$yucca_bg_color = yucca_get_theme_option( 'front_page_contacts_bg_color' );
	...
	>
		<div class="front_page_section_content_wrap front_page_section_contacts_content_wrap content_wrap">
			...
			$yucca_caption     = yucca_get_theme_option( 'front_page_contacts_caption' );
			$yucca_description = yucca_get_theme_option( 'front_page_contacts_description' );
			if ( ! empty( $yucca_caption ) || ! empty( $yucca_description ) || ( current_user_can( 'edit_theme_options' ) && is_customize_preview() ) ) {
				...
				if ( ! empty( $yucca_caption ) || ( current_user_can( 'edit_theme_options' ) && is_customize_preview() ) ) {
					?>
					<h2 class="front_page_section_caption front_page_section_contacts_caption front_page_block_<?php echo ! empty( $yucca_caption ) ? 'filled' : 'empty'; ?>">
					<?php
				...
				if ( ! empty( $yucca_description ) || ( current_user_can( 'edit_theme_options' ) && is_customize_preview() ) ) {
					?>
					<div class="front_page_section_description front_page_section_contacts_description front_page_block_<?php echo ! empty( $yucca_description ) ? 'filled' : 'empty'; ?>">
					<?php
			...
			// Content (text)
			$yucca_content = yucca_get_theme_option( 'front_page_contacts_content' );
			$yucca_layout  = yucca_get_theme_option( 'front_page_contacts_layout' );
			...
			if ( ( ! empty( $yucca_content ) || ( current_user_can( 'edit_theme_options' ) && is_customize_preview() ) ) ) {
				?>
				<div class="front_page_section_content front_page_section_contacts_content front_page_block_<?php echo ! empty( $yucca_content ) ? 'filled' : 'empty'; ?>">
					<?php
			...
			if ( ! empty( $yucca_sc ) || ( current_user_can( 'edit_theme_options' ) && is_customize_preview() ) ) {
				?>
				<div class="front_page_section_output front_page_section_contacts_output front_page_block_<?php echo ! empty( $yucca_sc ) ? 'filled' : 'empty'; ?>">
					<?php
