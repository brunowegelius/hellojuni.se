...
if ( ! function_exists( 'yucca_woocommerce_get_css' ) ) {
	add_filter( 'yucca_filter_get_css', 'yucca_woocommerce_get_css', 10, 2 );
	function yucca_woocommerce_get_css( $css, $args ) {
...
$fdir = yucca_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
